...
Note: You will have to setup your own mySQL server to run this program and add an appsettings.json file with this paramater 
  ...
  Once this is in place run add-migration "setup" in your package console.
  Then run "update database" in your package manager console and the program should now work and be connected to your new DB.

Example of program:
<img width="1526" height="1070" alt="image" src="https://github.com/user-attachments/assets/708722d0-51e0-4de1-ba74-4a865346f61a" />
